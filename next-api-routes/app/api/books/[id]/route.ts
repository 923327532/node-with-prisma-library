...
// PUT - Actualizar un libro específico
export async function PUT(
  ...
  try {
    ...
    // Validación si se envía el título
    ...
    // Validación si se envía el número de páginas
    if (pages && pages < 1) {
      return NextResponse.json(
    ...
    // Verificar si el autor existe si se está intentando cambiar el authorId
    if (authorId) {
